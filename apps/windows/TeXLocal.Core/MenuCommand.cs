...
public static class MenuCommands
{
    ...
    /// page or a native box — and find next and previous to the editor page's
    /// find panel, which also answers F3 and Shift+F3, so the menu shows their
    /// chords but never claims them.
    /// </summary>
