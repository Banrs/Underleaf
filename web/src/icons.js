// Stroke icons on a 24px grid, drawn to one optical weight so they sit
// consistently next to SF Pro text. Paths adapted from Lucide (ISC licence) —
// SF Symbols themselves can't be redistributed outside Apple's own frameworks,
// so these stand in for them and follow the same naming.
...
const PATHS = {
  ...
  'doc-tex': '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',
  ...
  star: '<path d="M11.5 3.2a.5.5 0 0 1 .9 0l2.2 4.5 5 .7a.5.5 0 0 1 .3.9l-3.6 3.5.9 5a.5.5 0 0 1-.8.5L12 16l-4.4 2.3a.5.5 0 0 1-.8-.5l.9-5-3.6-3.5a.5.5 0 0 1 .3-.9l5-.7z"/>',
  ...
  // Summation drawn as geometry, not the ∑ character — a text glyph sits
